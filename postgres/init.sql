...
-- 8. Latency probe targets added from the dashboard UI
--    (built-in targets stay in node-api/latency-targets.js)
...
-- 9. Recurring chores (household-shared; completions live on the row)
...
-- 10. Habits (household-shared; completions keyed by YYYY-MM-DD)
