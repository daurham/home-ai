...
The household weekly budget lives in `expense_settings` (singleton, default `$150.00`). Change it with `PATCH /api/expense-settings` (`weekly_budget` dollars or `weekly_budget_cents`).
